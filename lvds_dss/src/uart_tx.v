...
module uart_tx #(
    ...
    parameter CLK_HZ = 12_000_000, // Hz
    ...
    output reg                       uart_tx_busy, // Module busy sending previous item.
...
reg [COUNT_REG_LEN-1:0] bit_counter;

// Current and next states of the internal FSM
parameter FSM_IDLE = 2'b00;
parameter FSM_START = 2'b01;
parameter FSM_SEND = 2'b10;
